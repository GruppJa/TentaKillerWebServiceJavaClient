...
public class WebServiceLocator extends org.apache.axis.client.Service implements org.tentakiller.show.WebService {
    ...
    private java.lang.String WebServiceSoap_address = "http://localhost:8398/WebService.asmx";
    ...
    public org.tentakiller.show.WebServiceSoap getWebServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public org.tentakiller.show.WebServiceSoap getWebServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.tentakiller.show.WebServiceSoapStub _stub = new org.tentakiller.show.WebServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.tentakiller.show.WebServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                org.tentakiller.show.WebServiceSoapStub _stub = new org.tentakiller.show.WebServiceSoapStub(new java.net.URL(WebServiceSoap_address), this);
                _stub.setPortName(getWebServiceSoapWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://tentakiller.org/show", "WebService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://tentakiller.org/show", "WebServiceSoap"));
        }
